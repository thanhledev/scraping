...
namespace DataTypes
{
    public class GioVangChotSoSpawner : ISpawning
    {
        public List<string> CreateSearchPages(ArticleSource source, int depth)
        {
            ...
            ReverseCategories(ref temp, "index.php/category/" + source.Url, null, source);
        ...
        {
            List<string> result = new List<string>();
            string pattern = "index.php/category/" + chosenCategories.Slug;
